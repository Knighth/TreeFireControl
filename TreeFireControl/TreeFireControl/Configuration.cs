...
namespace TreeFireControl
{
    public class Configuration
    {
        ...
        public int TreeFireSpreadRate = 100;
        public int TreeFireDisasterSpreadRate = 100; //% of normal
        public bool DisableBuildingFires = false;
        public bool UseCustomLogFile = false;  //our setting to the custom log file name or not.
        public string CustomLogFilePath = Mod.MOD_CUSTOM_LOGPATH_DEFAULT;  //name of our default customlog filename
        public bool UseAlternateKeyBinding = false;  //our keybinding setting.
        public string AlternateKeyBindingCode = "LeftControl,LeftAlt,F"; //out keybinding default alternative.
...
//        public bool GuiUseAutoUpdate = true; //sore the gui screens autoupdate selection state.
        ...
        {
            var serializer = new XmlSerializer(typeof(Configuration));
            var config = new Configuration(); //if we fail at least return an empty one.
...
//            if(tmpConfig.TreeFireDisasterSpreadRate > 100 | tmpConfig.TreeFireDisasterSpreadRate < 0){}
